    ...
    if ((req.method === 'GET' || req.method === 'HEAD') && url.pathname === '/api/config') {
      return sendJson(res, {
        ...
        defaults: {
          ...
          teacherModel: process.env.DDO_TEACHER_MODEL || 'google/gemma-4-31b-it',
          studentModel: process.env.DDO_STUDENT_MODEL || 'google/gemma-4-31b-it',
          verifierModel: process.env.DDO_VERIFIER_MODEL || 'google/gemma-4-31b-it',
          baseURL: process.env.OPENAI_BASE_URL || '',
          horizon: Number(process.env.DDO_HORIZON || 5),
          epochs: Number(process.env.DDO_EPOCHS || 5),
          budget: Number(process.env.DDO_BUDGET || 20),
          patience: Number(process.env.DDO_PATIENCE || 2),
          maxTotalTokens: Number(process.env.DDO_MAX_TOTAL_TOKENS || 1000000),
