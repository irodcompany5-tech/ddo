DEFAULT_BEHAVIOR_SPEC = """Stepwise reasoning: decomposes non-trivial tasks before answering.
...
DEFAULT_INITIAL_PROMPT = (
    "You are a careful assistant. Follow the user's instructions, reason through the task, "
    "and provide a clear final answer."
)

TEACHER_POLICY_SYSTEM = """You are the teacher in Diagnostic Dialogue Optimization (DDO).
...
DIAGNOSIS_SYSTEM = """You are the diagnostician in Diagnostic Dialogue Optimization (DDO).
...
REPAIR_SYSTEM = """You are the prompt-repair operator in Diagnostic Dialogue Optimization (DDO).
...
VERIFIER_SYSTEM = """You are the verifier in Diagnostic Dialogue Optimization (DDO).
